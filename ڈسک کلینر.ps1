...
#GUI Variables
$FormTitleText = "ڈسک کلینر از جم ٹائلر (PowerShellEngineer.com)"
$SelectDiskLabelText = "ڈسک منتخب کریں:"
$FreeSpaceLabelText = "مفت جگہ (گیگا بائٹس): "
$TotalSpaceLabelText = "کل اسپیس (گیگا بائٹس): "
$JunkFoundLabelText = "جنک ملا (گیگا بائٹس):"
$CleanDiskBtnText = "کلین ڈسک *فائلیں حذف کریں*"
$SpaceCleanedLabelText = "صاف جگہ (گیگا بائٹس): "
$LogFileLabelText = "لاگ فائل ملی: $abcdefg"
$CreditLabelText = "اسکرپٹ از جم ٹائلر - PowerShellEngineer.com"
$LogFileLocatedText = "لاگ فائل مل گئی"
$AnalyzingDriveText = "ڈرائیوز کا تجزیہ کیا جا رہا ہے..."
$BrowsersAreRunningText = "براؤزر چل رہے ہیں... صارف کو مطلع کریں..."
$PleaseCloseBrowsersText = "براہ کرم تمام ویب براؤزرز بند کریں اور دوبارہ کوشش کریں۔"
$CleaningDriveText = "ڈرائیو کی صفائی..."
